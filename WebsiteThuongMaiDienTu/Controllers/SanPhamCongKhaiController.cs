...
namespace WebsiteThuongMaiDienTu.Controllers
{
    public class SanPhamCongKhaiController : Controller
    {
        ...
        public ActionResult ChiTiet(string id)
        {
            ...
            var loai = db.loaisanphams.FirstOrDefault(l => l.maloaisanpham == sanpham.maloaisanpham);
            var nsx = db.donvisanxuats.FirstOrDefault(d => d.madonvisanxuat == sanpham.madonvisanxuat);
